...
const ICONS = {
  alert: (
    <HiBellAlert className='h-6 w-6 text-gray-600 group-hover:text-indigo-600' />
  ),
  message: (
    <BiSolidMessageRounded className='h-6 w-6 text-gray-600 group-hover:text-indigo-600' />
  ),
};
      ...
      <Popover className='relative'>
        <Popover.Button className='inline-flex items-center outline-none'>
          <div className='w-8 h-8 flex items-center justify-center text-gray-800 relative'>
            <IoIosNotificationsOutline className='text-5xl  pt-3' />
            {data?.length > 0 && (
